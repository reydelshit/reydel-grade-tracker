...
"")
        ...
        self.title_label.setStyleSheet("background-color: #355935; color: white; border-radius: 5px; padding: 10px;")
        font = QtGui.QFont()
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Student Grade Tracker"))
        self.title_label.setText(_translate("Form", "Student Grade Tracker"))
        ...
        self.label_4.setText(_translate("Form", "Course"))
        ...
        self.label_6.setText(_translate("Form", "Grade"))
